...
const gradients = [
  ...
  'linear-gradient(to left, #1d2b64, #f8cdda);',
  ...
  'linear-gradient(to left, #003973, #e5e5be);',
  'linear-gradient(to left, #E7E9BB, #403B4A);',
  ...
  'linear-gradient(to left, #2b5876, #4e4376);',
  ...
  'linear-gradient(to left, #1c92d2, #f2fcfe);',
  'linear-gradient(to left, #36d1dc, #5b86e5);',
  'linear-gradient(to left, #cb356b, #bd3f32);',
  'linear-gradient(to left, #3a1c71, #d76d77, #ffaf7b);',
  'linear-gradient(to left, #283c86, #45a247);',
  'linear-gradient(to left, #ef3b36, #ffffff);',
  'linear-gradient(to left, #c0392b, #8e44ad);',
  'linear-gradient(to left, #159957, #155799);',
  'linear-gradient(to left, #000046, #1cb5e0);',
